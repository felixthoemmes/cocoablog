...
*UPDATE (7/11/18):* I was still thinking about this, and I believe that the point that I was trying to make (that balance tests check whether your randomization was compromised by factors that are unknown to you - meaning that they are tests of the randomization itself) was actually also made by Stephen Senn, in a paper in which he argued against balance tests to select covariates to adjust on. In the paper he writes (p.1717): "... I am prepared to concede a minimal role for a test of baseline balance as a test of randomization." It is exactly this minimal role that I tried to advocate in the blog post. Senn explains further that he believes that only an "clumsy crook" would be detected through such tests, and that the tests should probably not be conducted by the same people that were trying to cheat in the first place. Both are good reasons - yet, some cheaters are clumsy (as we have seen in the description of how Diedrik Stapel faked his data) - and sometimes researchers are honest enough to report balance statistic of trials that could have gone wrong, because randomization was done in the "wild". In summary, I concur with Senn that balance tests have some limited value, and should be performed. 
